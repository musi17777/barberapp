...
public class ClientLogin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v =  inflater.inflate(R.layout.fragment_client_login, container, false);
         this.emailEditText = v.findViewById(R.id.clientLoginEmailEditText);
         this.passwordEditText = v.findViewById(R.id.clientLoginPasswordEditText);
                ...
                .addOnCompleteListener(requireActivity(), new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            Navigation.findNavController(v).navigate(R.id.action_clientLogin_to_clientAppointment);
                        }
                        else
                        {
